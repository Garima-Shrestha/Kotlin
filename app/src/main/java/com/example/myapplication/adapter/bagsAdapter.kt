...
class bagsAdapter
    ...
    val descList: ArrayList<String>): RecyclerView.Adapter<bagsAdapter.adapterViewHolder>()
    {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): adapterViewHolder {
            val itemView: View=LayoutInflater.from(context).inflate(R.layout.bag_sample, parent, false)
